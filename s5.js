...
function helper(){
    ...
    drawSeparator();
    drawRectangle(user.x, user.y, user.width, user.color);
    drawRectangle(cpu.x, cpu.y, cpu.width, cpu.color);
    drawCircle(ball.x, ball.y, ball.radius, ball.velX, ball.velY, ball.speed, ball.color);
}
